...
bool Swapchain::createSwapchain(int width, int height) {
    ...
    // NOTE: SAMPLED_BIT is required by Skia Graphite's validation even if we only render to it
    ...
    // Add SAMPLED_BIT for Skia Graphite compatibility (required by validation)
